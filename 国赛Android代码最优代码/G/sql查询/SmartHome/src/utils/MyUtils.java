...
public class MyUtils {
	...
	public static CMD alert, curtian, lamp, fan, tv, air, dvd, door;
	public static final String IP = "18.1.10.7";
	...
	public static void init() {
		...
		controls.add(curtian = new CMD(ConstantUtil.Curtain, "3", "1", "2"));
		...
		if (sdb == null) {
			sdb = MyApplication.getContext().openOrCreateDatabase(
					"smarthome.db", 0, null);
			sdb.execSQL("create table if not exists datas(time varchar not null,ill double not null,temp double" +
					" not null)");
		}
	}
